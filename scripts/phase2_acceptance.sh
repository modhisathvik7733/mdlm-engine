...
ls -lh "$RESULTS_DIR"
echo
echo "v0.2.0 gate thresholds (compare to v0.1.0 baseline):"
...
echo "  Cache equivalence      n/a in v0.1.0  v0.2.0 verdict: PASS"
echo "  NaN count              v0.1.0=0     v0.2.0 must = 0"
echo
echo "If all green → tag v0.2.0 and ship. If Dream pass@1 regressed >5pp,"
echo "the cache wiring is corrupting outputs — see cache_equivalence log."
